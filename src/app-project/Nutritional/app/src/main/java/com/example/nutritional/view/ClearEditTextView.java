package com.example.nutritional.view;
...
public class ClearEditTextView extends androidx.appcompat.widget.AppCompatEditText implements View.OnFocusChangeListener, TextWatcher {
    //右边的删除按钮
