...
function fanimgChange() {
    while (true) {
        $("#fanimg").attr("src", "img/pic_fan_up.png")
        $("#fanimg").attr("src", "img/pic_cartoon_fan_1.png")
        $("#fanimg").attr("src", "img/pic_cartoon_fan_2.png")
        $("#fanimg").attr("src", "img/pic_cartoon_fan_3.png")
        $("#fanimg").attr("src", "img/pic_cartoon_fan_4.png")
        $("#fanimg").attr("src", "img/pic_cartoon_fan_5.png")
    }
}
